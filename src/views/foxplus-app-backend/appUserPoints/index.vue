			...
			<el-row v-show="showSearch">
				<el-form :model="state.queryForm" ref="queryRef" :inline="true" @keyup.enter="getDataList">
					...
					<el-form-item label="有效期" prop="expireTime">
						<el-date-picker type="datetime" placeholder="请输入有效期" v-model="state.queryForm.expireTime"></el-date-picker>
					</el-form-item>
					<el-form-item>
			...
			<el-row>
				<div class="mb8" style="width: 100%">
					...
					<el-button
						...
						icon="Delete"
						type="primary"
						v-auth="'foxplus-app-backend_appUserPoints_del'"
					...
					<right-toolbar
						...
						:export="'foxplus-app-backend_appUserPoints_export'"
				...
				<el-table-column label="操作" width="150">
					<template #default="scope">
						<el-button
							...
							text
							type="primary"
							v-auth="'foxplus-app-backend_appUserPoints_edit'"
							@click="formDialogRef.openDialog(scope.row.id)"
							>编辑</el-button
						>
						<el-button icon="delete" text type="primary" v-auth="'foxplus-app-backend_appUserPoints_del'" @click="handleDelete([scope.row.id])"
							>删除</el-button
						>
					</template>
				</el-table-column>

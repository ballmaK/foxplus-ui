    ...
    <div class="layout-padding-auto layout-padding-view">
      ...
      <el-table :data="state.dataList" v-loading="state.loading" border 
        ...
        <el-table-column type="index" label="#" width="40" />
          ...
          <el-table-column prop="holdVolume" label="股票持仓"  show-overflow-tooltip/>
          <el-table-column prop="validVolume" label="股票可用"  show-overflow-tooltip/>
          <el-table-column prop="costPrice" label="股票成本价"  show-overflow-tooltip/>

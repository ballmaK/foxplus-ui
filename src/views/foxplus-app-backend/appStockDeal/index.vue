    ...
    <div class="layout-padding-auto layout-padding-view">
      ...
      <el-row>
        <div class="mb8" style="width: 100%">
          <el-button icon="folder-add" type="primary" class="ml10" @click="formDialogRef.openDialog()"
            v-auth="'foxplus-app-backend_appStockDeal_add'">
            新 增
          </el-button>
          <el-button plain :disabled="multiple" icon="Delete" type="primary"
            v-auth="'foxplus-app-backend_appStockDeal_del'" @click="handleDelete(selectObjs)">
            删除
          </el-button>
          <right-toolbar v-model:showSearch="showSearch" :export="'foxplus-app-backend_appStockDeal_export'"
      ...
      <template #default="scope">
        ...
        <el-table-column label="操作" width="150">
          <template #default="scope">
            <el-button icon="edit-pen" text type="primary" v-auth="'foxplus-app-backend_appStockDeal_edit'"
              @click="formDialogRef.openDialog(scope.row.id)">编辑</el-button>
            <el-button icon="delete" text type="primary" v-auth="'foxplus-app-backend_appStockDeal_del'" @click="handleDelete([scope.row.id])">删除</el-button>
          </template>
        </el-table-column>
      </el-table>
...
<script setup lang="ts" name="systemAppStockDeal">
import { BasicTableProps, useTable } from "/@/hooks/table";
import { fetchList, delObjs } from "/@/api/foxplus-app-backend/appStockDeal";
...
// 导出excel
const exportExcel = () => {
  downBlobFile('/foxplus-app-backend/appStockDeal/export',Object.assign(state.queryForm, { ids: selectObjs }), 'appStockDeal.xlsx')
}
